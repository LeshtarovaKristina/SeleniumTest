...
public class CalenderHandling {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String dMnonthText = dMonth.getText();

        while (!dMnonthText.equals("August")) {
            nextButton.click();
            dMnonthText = dMonth.getText();
        }
        List<WebElement> departDates = driver.findElements(By.xpath("//tbody[@class = 'dldatepicker-tbody-0']/tr/td"));
